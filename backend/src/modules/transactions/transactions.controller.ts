...
import { GetTransactionsRequestDto, GetTransactionsResponseDto, TransactionDto } from './dto/list.dto';
...
export class TransactionsController {
  ...
  @UserOnly()
  getList(@Query() dto: GetTransactionsRequestDto, @CurrentUser() user: AuthPayload) {
